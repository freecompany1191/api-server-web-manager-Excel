...
public class ControllerErrorHandler {
	...
	public void authError(HttpServletRequest request, ServletResponse servletResponse, SignatureException ex)
			throws Exception {
		write((HttpServletResponse) servletResponse, HttpServletResponse.SC_UNAUTHORIZED, ex.getMessage());
	}

	@ExceptionHandler(AuthException.class)
	public void authError(HttpServletRequest request, ServletResponse servletResponse, AuthException ex)
			throws Exception {
		write((HttpServletResponse) servletResponse, HttpServletResponse.SC_UNAUTHORIZED, ex.getMessage());
	}
     */
