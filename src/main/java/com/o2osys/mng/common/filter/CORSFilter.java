package com.o2osys.mng.common.filter;
...
public class CORSFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        response.setHeader("Access-Control-Allow-Headers", "Accept, Accept-Language, Content-Language, Content-Type, Origin, X-Requested-With");
...
public class CORSFilter {
    ...
    public FilterRegistrationBean corsFilter() {
        ...
        //config.addAllowedMethod("POST, GET, HEAD, PATCH, DELETE, PUT, JSON, OPTIONS");
